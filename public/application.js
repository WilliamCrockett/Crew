...
var onNewCrew = function onNewCrew(data) {
  return $.ajax({
...
var getCrewByID = function getCrewByID(id) {
  return $.ajax({
...
var onEditCrewMember = function onEditCrewMember(data, id) {
  return $.ajax({
    url: config.apiOrigin + '/crews/' + id,
    method: 'PATCH',
    headers: {
...
var deleteCrewMember = function deleteCrewMember(id) {
  return $.ajax({
    url: config.apiOrigin + '/crews/' + id,
    method: 'DELETE',
    headers: {
...
var deleteEventRecord = function deleteEventRecord(id) {
  return $.ajax({
...
var createNewEvent = function createNewEvent(data) {
  return $.ajax({
...
var onEditEvent = function onEditEvent(data, id) {
  return $.ajax({
    url: config.apiOrigin + '/events/' + id,
    method: 'PATCH',
    headers: {
...
var createEventCrews = function createEventCrews(eID, cID) {
  return $.ajax({
...
var getEventCrewsByEventID = function getEventCrewsByEventID(id) {
  return $.ajax({
...
module.exports = {
  ...
  createEventCrews: createEventCrews,
  getEventCrewsByEventID: getEventCrewsByEventID,
...
var showCrewsTemplate = __webpack_require__(21);
var showEventsTemplate = __webpack_require__(38);
var addCrewToEventTemplate = __webpack_require__(39);
var crewsToExportTemplate = __webpack_require__(40);
var crewsToExportFullTemplate = __webpack_require__(41);
...
var onEditNewCrewMember = function onEditNewCrewMember(data) {
...
var onAddNewCrewMemberSuccess = function onAddNewCrewMemberSuccess() {
...
var onAddNewCrewMemberError = function onAddNewCrewMemberError() {
  $.toast({
...
var onUpdateExisitngCrewMemberSuccess = function onUpdateExisitngCrewMemberSuccess() {
...
var onUpdateExisitngCrewMemberFailure = function onUpdateExisitngCrewMemberFailure() {
  $.toast({
...
var onRowClickError = function onRowClickError() {
  $.toast({
...
var populateTableWithIndex = function populateTableWithIndex(data) {
  // const allCrew = data
  var showCrewsHtml = showCrewsTemplate({ crews: data.crews });
  $('#crewsTable tbody').empty();
  $('#crewsTable tbody').append(showCrewsHtml);
};

var populateTableWithIndexFailure = function populateTableWithIndexFailure() {
  $.toast({
...
var onDeleteRecordSuccess = function onDeleteRecordSuccess() {
  $.toast({
...
var onDeleteRecordFailure = function onDeleteRecordFailure() {
  $.toast({
...
var onDeleteEventRecordFailure = function onDeleteEventRecordFailure() {
  $.toast({
...
var onDeleteEventRecordSuccess = function onDeleteEventRecordSuccess() {
  $.toast({
...
var populateTableWithEvents = function populateTableWithEvents(data) {
  var showEventsHtml = showEventsTemplate({ events: data.events });
  $('#crewsTable tbody').empty();
...
var onNewEventSuccess = function onNewEventSuccess(data) {
...
var onNewEventFailure = function onNewEventFailure() {
  $.toast({
...
var getAllEventsError = function getAllEventsError() {
  $.toast({
...
var onEditEvent = function onEditEvent(data) {
...
var onEditEventError = function onEditEventError() {
  $.toast({
...
var onUpdateExisitngEventSuccess = function onUpdateExisitngEventSuccess(data) {
...
var onUpdateExisitngEventFailure = function onUpdateExisitngEventFailure() {
  $.toast({
    text: 'There was a problem while trying to update this',
    heading: 'Error!',
    icon: 'error',
...
var onAddCrewToEventUI = function onAddCrewToEventUI(data) {
  var showCrewsHtml = addCrewToEventTemplate({ crews: data.crews });
  $('#crewListInputBox').empty();
  $('#crewListInputBox').append(showCrewsHtml);
};

var addCrewToEventCrewSuccess = function addCrewToEventCrewSuccess() {
  $.toast({
...
var addCrewToEventCrewError = function addCrewToEventCrewError() {
  $.toast({
...
var populateModalWithCrewForEvent = function populateModalWithCrewForEvent(data) {
  var eventCrewsHtml = crewsToExportTemplate({ crews: data.crews });
  $('#crewToExportTable tbody').empty();
  $('#crewToExportTable tbody').append(eventCrewsHtml);

  var eventCrewsExportHtml = crewsToExportFullTemplate({ crews: data.crews });
  $('#crewsTableHidden tbody').empty();
  $('#crewsTableHidden tbody').append(eventCrewsExportHtml);
};

var getEventCrewsByEventIDError = function getEventCrewsByEventIDError() {
  $.toast({
...
module.exports = {
  onAddNewCrewMemberError: onAddNewCrewMemberError,
  onAddNewCrewMemberSuccess: onAddNewCrewMemberSuccess,
  onEditNewCrewMember: onEditNewCrewMember,
  onUpdateExisitngCrewMemberSuccess: onUpdateExisitngCrewMemberSuccess,
  onUpdateExisitngCrewMemberFailure: onUpdateExisitngCrewMemberFailure,
  onRowClickError: onRowClickError,
  populateTableWithIndex: populateTableWithIndex,
  populateTableWithIndexFailure: populateTableWithIndexFailure,
  onDeleteRecordSuccess: onDeleteRecordSuccess,
  showEvents: showEvents,
  onNewEventSuccess: onNewEventSuccess,
  onNewEventFailure: onNewEventFailure,
  getAllEventsError: getAllEventsError,
  onEditEvent: onEditEvent,
  onUpdateExisitngEventSuccess: onUpdateExisitngEventSuccess,
  onUpdateExisitngEventFailure: onUpdateExisitngEventFailure,
  onAddCrewToEventUI: onAddCrewToEventUI,
  addCrewToEventCrewSuccess: addCrewToEventCrewSuccess,
  addCrewToEventCrewError: addCrewToEventCrewError,
  onEditEventError: onEditEventError,
  populateModalWithCrewForEvent: populateModalWithCrewForEvent,
  getEventCrewsByEventIDError: getEventCrewsByEventIDError,
  onDeleteRecordFailure: onDeleteRecordFailure,
  onDeleteEventRecordFailure: onDeleteEventRecordFailure,
  onDeleteEventRecordSuccess: onDeleteEventRecordSuccess,
  populateTableWithEvents: populateTableWithEvents,
  createPDF: createPDF
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var appEvents = __webpack_require__(43);
...
var appAPI = __webpack_require__(7);
var appUI = __webpack_require__(8);
var getFormFields = __webpack_require__(10);

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.signIn(data).then(ui.onSignInSuccess).catch(ui.onSignInFailure).then(appAPI.getAll).then(appUI.populateTableWithIndex).catch(appUI.populateTableWithIndexFailure);
};
...
var onSignUp = function onSignUp(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.signUp(data).then(ui.onSignUpSuccess).catch(ui.onSignUpFailure); // TODO fix sign up ui update - ask about auto signing in and TODO fix sign up fialure
};
...
var onSignOut = function onSignOut() {
  // TODO clear all form fields EVERYWHERE
  event.preventDefault();
  api.signOut().then(ui.onSignOutSuccess) // TODO
...
var clearPwForm = function clearPwForm() {
...
var onToSignUp = function onToSignUp() {
  $('.sign-in-form').toggle();
  $('.sign-up-form').toggle();
...
var onToSignIn = function onToSignIn() {
  $('.sign-in-form').toggle();
  $('.sign-up-form').toggle();
  $('.sign-in-error').css('display', 'none');
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <tr class =\"crew_row\" data-id=\""
    ...
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sas_number : stack1), depth0))
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email_address : stack1), depth0))
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cell_number : stack1), depth0))
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.next_of_kin : stack1), depth0))
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.nok_cell_num : stack1), depth0))
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.shirt_size : stack1), depth0))
    + "</td>\n   <td><button class=\"btn btn-default delete_record\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete?</span></td>\n </tr>\n\n\n";
  ...
  return "<tr class='header_row'>\n  <td>Full Name</td>\n  <td>SAS Number</td>\n  <td>Email Address</td>\n  <td>Cell Number</td>\n  <td>Next of Kin</td>\n  <td>NoK Cell Number</td>\n  <td>Shirt Size</td>\n  <td>Delete</td>\n</tr>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.crews : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <tr class =\"crew_row\" data-id=\""
    ...
    + "</td>\n   <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.event_date : stack1), depth0))
    + "</td>\n    <td><button class=\"btn btn-default export_crew_list\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Export?</span></td>\n    <td><button class=\"btn btn-default delete_event_record\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete?</span></td>\n </tr>\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<tr class='header_row'>\n  <td>Event Name</td>\n  <td>Event Date</td>\n  <td>Export Crew List</td>\n  <td>Delete Event</td>\n</tr>\n\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n<label class=\"checkbox pad-5\">\n<input class=\"col-md-2 pad-5 crew-check-boxes\" type=\"checkbox\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.full_name : stack1), depth0))
    + "\">"
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.crews : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var onRowClick = function onRowClick(event) {
  var currentDisplay = $('#eventsOrCrew').text();
  if (currentDisplay === 'Events') {
    var id = $(this).attr('data-id');
    api.getCrewByID(id).then(ui.onEditNewCrewMember).catch(ui.onRowClickError);
  } else if (currentDisplay === 'Crews') {
    var _id = $(this).attr('data-id');
    api.getEventByID(_id).then(ui.onEditEvent).catch(ui.onEditEventError);
  }
};

var onSaveUpdatedBoatDetails = function onSaveUpdatedBoatDetails(event) {
  event.preventDefault(); // TODO post MVP
};

var onEditExistingCrewMember = function onEditExistingCrewMember(event) {
  event.preventDefault();
  var data = getFormFields(this);
  var id = $('#userID').text();
  api.onEditCrewMember(data, id).then(ui.onUpdateExisitngCrewMemberSuccess).catch(ui.onUpdateExisitngCrewMemberFailure).then(api.getAll).then(ui.populateTableWithIndex).catch(ui.populateTableWithIndexFailure); // was here
};

var onAddNewCrewMember = function onAddNewCrewMember(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.onNewCrew(data).then(ui.onAddNewCrewMemberSuccess).catch(ui.onAddNewCrewMemberError).then(api.getAll).then(ui.populateTableWithIndex).catch(ui.populateTableWithIndexFailure);
};
...
var deleteCrewRecord = function deleteCrewRecord(event) {
  event.preventDefault();
  event.stopPropagation();
  api.deleteCrewMember(dataID).then(ui.onDeleteRecordSuccess).catch(ui.onDeleteRecordFailure).then(api.getAll).then(ui.populateTableWithIndex).catch(ui.populateTableWithIndexFailure);
  $('#confirmDelete').modal('hide');
};

var deleteEventRecord = function deleteEventRecord(event) {
  event.preventDefault();
  api.deleteEventRecord(eventDataID).then(ui.onDeleteEventRecordSuccess).catch(ui.onDeleteEventRecordFailure).then(api.getAllEvents).then(ui.populateTableWithEvents).catch(ui.getAllEventsError);
  $('#confirmEventDelete').modal('hide');
};

var showModalDeleteConfirm = function showModalDeleteConfirm(event) {
  event.stopPropagation();
...
var showModalDeleteEvent = function showModalDeleteEvent(event) {
  event.stopPropagation();
...
var showNewEventModal = function showNewEventModal(event) {
  event.preventDefault();
  $('#newEventModal').modal('show');
};

var onNewEvent = function onNewEvent(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createNewEvent(data).then(ui.onNewEventSuccess).catch(ui.onNewEventFailure).then(api.getAllEvents).then(ui.showEvents).catch(ui.getAllEventsError).then(getLastEventID);
};

var getLastEventID = function getLastEventID() {
  api.getLastEvent().then(createNewEventCrew).catch();
};

var createNewEventCrew = function createNewEventCrew(data) {
  var currentEventId = data.event['id'];
  for (var i = 0; i < checkedValues.length; i++) {
    var crewId = checkedValues[i];
    api.createEventCrews(currentEventId, crewId).then(ui.addCrewToEventCrewSuccess).catch(ui.addCrewToEventCrewError);
  }
};

var onToggleBetweenEventsAndCrew = function onToggleBetweenEventsAndCrew(event) {
  event.preventDefault();
  var currentDisplay = $('#eventsOrCrew').text();
  if (currentDisplay === 'Events') {
    api.getAllEvents().then(ui.showEvents).catch(ui.getAllEventsError); // TODO
  } else if (currentDisplay === 'Crews') {
    api.getAll().then(ui.populateTableWithIndex).catch(ui.populateTableWithIndexFailure);
    $('#eventsOrCrew').text('Events');
  }
};

var showModalExportEvent = function showModalExportEvent(event) {
  event.stopPropagation();
  var eventId = $(this).attr('data-id');
  $('#EventExportID').text(eventId);
  $('#exportEvent').modal('show');
  api.getEventCrewsByEventID(eventId).then(ui.populateModalWithCrewForEvent).catch(ui.getEventCrewsByEventIDError);
};
...
var editEvent = function editEvent(event) {
  ...
  var data = getFormFields(this);
  var id = $('#EventID').text();
  api.onEditEvent(data, id).then(ui.onUpdateExisitngEventSuccess).catch(ui.onUpdateExisitngEventFailure).then(api.getAllEvents).then(ui.showEvents).catch(ui.getAllEventsError);
};

var onAddCrewToEvent = function onAddCrewToEvent() {
  $('#addCrewToEvent').modal('show');
  api.getAll().then(ui.onAddCrewToEventUI).catch(ui.addCrewToEventCrewError);
};
...
var exportCrewList = function exportCrewList() {
  var eventId = $('#EventExportID').text();
  api.getEventCrewsByEventID(eventId).then(ui.createPDF);
